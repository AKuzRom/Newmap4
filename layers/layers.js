...
var lyr_C_1 = new ol.layer.Image({
                            opacity: 1,
                            title: 'Cумма температур > 10 град <br><img src ="images/Legend.png" width= "100px"><br>',
...
lyr_K_0.setVisible(true);lyr_C_1.setVisible(false);lyr_T_2.setVisible(false);lyr_P_3.setVisible(true);
var layersList = [lyr_K_0,lyr_C_1,lyr_T_2,lyr_P_3];
lyr_T_2.set('fieldAliases', {'name': 'Название района', 'Co': 'Co, мг/кг', 'Cu': 'Cu, мг/кг', 'Zn': 'Zn, мг/кг', });
lyr_P_3.set('fieldAliases', {'name': 'Название района', 'area': 'Площадь, га', 'plow': 'площадь обрабатываемых земель', });
